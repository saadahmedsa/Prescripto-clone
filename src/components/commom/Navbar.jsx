...
const Navbar = () => {
  ...
  const NavLink = ({ href, children, onClick }) => {
    ...
    return (
      <Link href={href} onClick={onClick} className="relative">
        {children}
        <hr
          className={`absolute bottom-[-6px] left-1/2 transform -translate-x-1/2 h-[2px] w-3/5 bg-primary border-none ${
  ...
  return (
    <div className="py-5 mb-5 text-sm flex justify-between items-center border-b border-b-gray-300 px-4 md:px-10">
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed lg:hidden top-0 right-0 h-full w-full bg-white z-50 shadow-lg transform transition-transform duration-300 ${
